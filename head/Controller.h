...
protected:
	Controller(const Version& v, const string& p1name, const string& p2name, unsigned int AI_player1, unsigned int AI_player2)
		: version(v), clanGame(Game(v)), clanDeck(new Deck(Game(v))), board(Board()), player1(new Player(p1name)), player2(new Player(p2name)) {
...
public :
	TacticController(const Version& v, const string& name_player1, const string& name_player2, unsigned int AI_player1, unsigned int AI_player2)
		: Controller(Version::legacy, name_player1, name_player2, AI_player1, AI_player2), tacticGame(Game(v)), tacticDeck(new Deck(Game(v))) {
