...
int main() {
	...
	UserInterface::getInstance().setState(1);*/

	
	/*Version selected_version = UserInterface::getInstance().UIinterfaceVersionMenu();
	string players_name[2];
	UserInterface::getInstance().UIinterfacePlayerMenu(players_name);
